//To find the area of the rectange 
/*
#include<stdio.h>
int main(){
    int L,B,C;
...
//Write a C program to calculate Compound Interest. Take
//Principal, Time and rate of interest from user
/*
#include <stdio.h>
...
//To print the length of all sides
...
int main() {
    ...
    float lengthAB = sqrt(pow(x2 - x1, 2) + pow(y2 - y1, 2));
    float lengthBC = sqrt(pow(x3 - x2, 2) + pow(y3 - y2, 2));
    float lengthAC = sqrt(pow(x3 - x1, 2) + pow(y3 - y1, 2));
...
//To Write Program given the sides of Octahedron then calculate the surface area.
...
int main() {
    ...
    printf("Enter the length of the side of the octahedron: ");
    scanf("%f", &a);
    surfaceArea = 2 * sqrt(3) * a * a;
